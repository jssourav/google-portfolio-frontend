    ...
    <div className='dropdown' onClick={handleToggle} ref={wrapperRef}>
      ...
      <div
        ...
        <div className='drop-item'>
          ...
          <a className='drop-link' href='mailto:sn.sourav1993@gmail.com'>
            <img src={email} alt='' />
            <p> Email </p>
          </a>
          <a className='drop-link' href='https://github.com/jssourav'>
            <img src={gh} alt='' />
            <p> GitHub </p>
          </a>
          <a className='drop-link' href='https://www.linkedin.com/in/souravn/'>
            <img src={li} alt='' />
            <p> LinkedIn </p>
          </a>
        </div>
